...
class Common1_model extends CI_Model {
 ...
 public function getMobileLeaveList($params){
        $sql = "SELECT a.id as emp_id,a.name,a.biometricAccess,a.profileimage,a.fwd1,a.fwd2,a.fwd3,a.fwd4,b.type,b.duration,b.reason,b.from_date,b.to_date,b.leave_id,b.fwd_1_status,b.fwd_2_status,b.fwd_3_status,b.fwd_4_status,b.main_status
        FROM `hrms_staffmaster` as a
        INNER JOIN `hrms_leave` as b ON b.staff_id_fk = a.id 
        WHERE a.id =".$params['staff_id_fk'];        
        return $this->db->query($sql)->result();
    }

    public function getMobilePermissionList($params){
        $sql = "SELECT a.id as emp_id,a.name,a.biometricAccess,a.profileimage,a.fwd1,a.fwd2,a.fwd3,a.fwd4,b.date,b.reason,b.fromtime,b.totime,b.permission_id,b.fwd_1_status,b.fwd_2_status,b.fwd_3_status,b.fwd_4_status,b.main_status
        FROM `hrms_staffmaster` as a
        INNER JOIN `hrms_permission` as b ON b.staff_id_fk = a.id 
        WHERE a.id =".$params['staff_id_fk'];        
        return $this->db->query($sql)->result();
    }

    public function getMobileNightshiftList($params){
        $sql = "SELECT a.id as emp_id,a.name,a.biometricAccess,a.profileimage,a.fwd1,a.fwd2,a.fwd3,a.fwd4,b.date,b.purpose,b.fromtime,b.totime,b.nightshift_id,b.fwd_1_status,b.fwd_2_status,b.fwd_3_status,b.fwd_4_status,b.main_status
        FROM `hrms_staffmaster` as a
        INNER JOIN `hrms_nightshift` as b ON b.staff_id_fk = a.id 
        WHERE a.id =".$params['staff_id_fk'];        
        return $this->db->query($sql)->result();
    }

    public function getMobileDelegationList($params){
        $sql = "SELECT a.id as emp_id,a.name,a.biometricAccess,a.profileimage,a.fwd1,a.fwd2,a.fwd3,a.fwd4,b.date,b.purpose,b.fromtime,b.totime,b.delegation_id,b.fwd_1_status,b.fwd_2_status,b.fwd_3_status,b.fwd_4_status,b.main_status
        FROM `hrms_staffmaster` as a
        INNER JOIN `hrms_delegation` as b ON b.staff_id_fk = a.id 
        WHERE a.id =".$params['staff_id_fk'];        
        return $this->db->query($sql)->result();
    }
}