...
class Server{
	...
	*/
	public function password_credentials($user){
		// $users = array("user" => array("password" => $user['password'], 'first_name' => $user['first_name'], 'last_name' => $user['last_name']));
		$storage = new OAuth2\Storage\Memory(array('user_credentials' => $user));
		// echo "<pre>";
		// print_r($storage);
